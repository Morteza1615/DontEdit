...
markupstart.add(types.InlineKeyboardButton('👤توسعه دهنده👤', url='https://telegram.me/Contributive'), types.InlineKeyboardButton('📢کانال📢', url='https://telegram.me/Special_Programing'))
